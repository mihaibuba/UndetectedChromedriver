    ...
    private void _headless() {
        ...
        params1.put(
                ...
                "Object.defineProperty(window, 'navigator', {\n"
                        ...
                        + "        has: (target, key) => (key === 'webdriver' ? false : key in"
                        + " target),\n"
                        + "        get: (target, key) =>\n"
                        + "            key === 'webdriver' ?\n"
                        + "            false :\n"
        ...
        params2.put(
                "userAgent",
                ((String) this.executeScript("return navigator.userAgent"))
                        .replace("Headless", ""));
        ...
        params4.put(
                ...
                "Object.defineProperty(navigator.connection, 'rtt', {get: () => 100});\n"
                    ...
                    + "\n"
                    + "const nativeToStringFunctionString = Error.toString().replace(/Error/g,"
                    + " 'toString')\n"
                ...
                (List<String>)
                        this.executeScript(
                                "let objectToInspect = window,\n"
                                    ...
                                    + " i.match(/.+_.+_(Array|Promise|Symbol)/ig))");
