...
public class ChromeDriverBuilder {
    ...
    private ChromeOptions setHostAndPort(ChromeOptions chromeOptions) throws RuntimeException {
        ...
        try {
            Field experimentalOptions =
                    chromeOptions
                            .getClass()
                            .getSuperclass()
                            .getDeclaredField("experimentalOptions");
            experimentalOptions.setAccessible(true);
            Map<String, Object> experimentals =
                    (Map<String, Object>) experimentalOptions.get(chromeOptions);
        ...
        chromeOptions.setExperimentalOption(
                "debuggerAddress", debugHost + ":" + String.valueOf(debugPort));
        return chromeOptions;
    }
     ...
     * @param prefs
     */
    private void handlePrefs(String userDataDir, Map<String, Object> prefs)
            throws RuntimeException {
        ...
        if (new File(prefsFile).exists()) {
            ...
            try (BufferedWriter bw =
                    new BufferedWriter(new FileWriter(prefsFile, StandardCharsets.ISO_8859_1))) {
    ...
    private ChromeOptions fixExitType(ChromeOptions chromeOptions) {
        ...
        try {
            String filePath =
                    _userDataDir + File.separator + "Default" + File.separator + "Preferences";
    ...
    public ChromeDriver build(
        ...
        try {
            Field argsField =
                    options.getClass().getSuperclass().getDeclaredField("experimentalOptions");
            argsField.setAccessible(true);
    ...
    public ChromeDriver build(
            ...
            boolean needPrintChromeInfo) {
        return this.build(
                options, driverExecutablePath, null, suppressWelcome, needPrintChromeInfo);
    }
     ...
     * @return
     */
    public ChromeDriver build(ChromeOptions options, String driverExecutablePath) {
